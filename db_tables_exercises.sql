...
-- 15. EXERCISE SOLUTION: CREATE TABLE <table_name> (column_name1 datatype DEFAULT null, column_name 2 datatype DEFAULT null, column_name3 datatype DEFAULT not null PRIMARY KEY <column_name>);
