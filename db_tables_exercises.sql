...
-- 14. What is the relationship between the employees and the department’s tables?: employees table is a running list of all employee information and the department table is a running list of all departments. the dept_emp table likely show what employees work in each department.
